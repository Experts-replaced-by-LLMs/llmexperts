...
Welcome to `llmexperts` contributor's guide.
...
If you experience bugs or general issues with `llmexperts`, please have a look
...
You can help improve `llmexperts` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`llmexperts` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `llmexperts`'s files. While this mechanism can
...
```
conda create -n llmexperts python=3 six virtualenv pytest pytest-cov
conda activate llmexperts
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/llmexperts.git
   cd llmexperts
   ```
...
5. Install [pre-commit]:
   ...
   `llmexperts` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/llmexperts
[issue tracker]: https://github.com/<USERNAME>/llmexperts/issues
